...
class HomeController extends Controller
{
    public function index()
    {
        ...
        $pasar = Pasar::count();
        $tahun2021 = Traffic::whereYear('tanggal', 2024)->get()->count();
        $tahun2022 = Traffic::whereYear('tanggal', 2025)->get()->count();
        $tahun2023 = Traffic::whereYear('tanggal', 2026)->get()->count();
