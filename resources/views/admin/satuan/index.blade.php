...
<div class="row">
    <div class="col-lg-6">
        <div class="card m-b-20">
            <div class="card-body">
                <form class="" action="/data/satuan/add" method="POST">
                    @csrf
                    <div class="form-group">
                        <label>Nama Satuan Bahan</label>
                        <input type="text" class="form-control" name="nama" placeholder="Nama Satuan Bahan" required>
                    </div>
