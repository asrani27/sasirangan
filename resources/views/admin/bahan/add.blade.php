...
<div class="row">
    <div class="col-12">
        <div class="card m-b-20">
            <div class="card-body">
                <form method="POST" action="/data/bahan/add" enctype="multipart/form-data">
                    @csrf
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control" type="text" placeholder="Nama Bahan" name="nama" id="example-text-input" required>
                    </div>
                </div>
                <div class="form-group row">
