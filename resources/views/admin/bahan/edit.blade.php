        ...
        <div class="card m-b-20">
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control" type="text" name="acuan" value="{{$data->acuan}}" onkeypress="return hanyaAngka(event)" id="example-text-input" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="example-text-input" class="col-sm-2 col-form-label">Batas Kenaikan</label>
                    <div class="col-sm-10">
                        <input class="form-control" type="text" name="batas" value="{{$data->batas}}" onkeypress="return hanyaAngka(event)" id="example-text-input" required>
                    </div>
                </div>
                <div class="form-group row">
