                        ...
                        @foreach ($data as $item)
                            <tr style="padding:5px 12px;">
                                ...
                                <td style="padding:5px 12px;">
                                    <a href="/informasi/bahan/edit/{{$item->id}}" class="btn btn-sm btn-success waves-effect waves-light"><i class="fas fa-edit"></i></a>
                                    <a href="/informasi/bahan/delete/{{$item->id}}" class="btn btn-sm btn-danger waves-effect waves-light" onclick="return confirm('Yakin menghapus Berita ini?');"><i class="fas fa-times"></i></a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
