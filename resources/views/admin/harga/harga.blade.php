            ...
            <div class="btn-toolbar p-3" role="toolbar">
                <div class="col-md-10">
                    <form method="get" action="/input/harga/fulldate/{{$pasar->id}}">
                        @csrf
                        <div class="btn-group">
                            <a href="/input/harga" class="btn btn-secondary waves-light waves-effect"><i
                ...
                {{-- <div class="col-md-2">
                    ...
                    <div class="btn-group">
                        <input type="text" class="form-control" placeholder="Cari"><a href="#"
                ...
                <table class="table table-striped table-bordered mb-0">
                    ...
                    <tbody>
                        ...
                        <tr style="padding:5px 12px;">
                            ...
                            <td style="padding:5px 12px;">Rp. <a href="#" class="inline-username" data-type="text"
                                    data-pk="{{$b->id}}" data-pasar="{{$pasar->id}}"
                                    data-tanggal="{{\Carbon\Carbon::today()->format('Y-m-d')}}">{{$b->harga}}</a></td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
            ...
            <div class="btn-toolbar p-3" role="toolbar">
                <div class="col-md-10">
                    <form method="get" action="/input/harga/fulldate/{{$pasar->id}}">
                        @csrf
                        <div class="btn-group">
                            <a href="/input/harga/{{$pasar->id}}" class="btn btn-danger waves-light waves-effect"><i
                                    class="fas fa-arrow-alt-circle-left"></i> Kembali</a>
                        </div>
                        <div class="btn-group">
                            <select class="form-control" name="bulan" required>
                ...
                <table class="table table-striped table-bordered mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="#" class="inline-username" data-type="text" data-pk="{{$b->id}}"
                                    data-pasar="{{$pasar->id}}"
                                    data-tanggal="{{$tahun}}-{{$bulan}}-{{$key+1}}">{{$s}}</a></td>
                            @endforeach
                        </tr>
                        @endforeach
                    </tbody>
